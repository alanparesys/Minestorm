...
Rectangle2D Rectangle2D_SetFrom4Points(Vector2D p1, Vector2D p2, Vector2D p3,
	Vector2D p4);
Rectangle2D Rectangle2D_SetFrom1Point2Vectors(Vector2D p1, Vector2D v1, Vector2D v2
);
Rectangle2D Rectangle2D_SetFromCenterLengthWidthAngle(Vector2D center, float length
